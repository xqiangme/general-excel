 ...
 * @author mengqiang
 */
public class GenExcelStringPool {
    ...
    public static final String DASH2 = "_";
    ...
    public static final String FOUR_NEW_LINE = "\n";
    ...
    public static final String QUESTION_MARK_ESCAPE = "\\?";
    ...
    public static final String ß = "ß";
